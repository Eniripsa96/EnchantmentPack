...
import com.sucy.trap.data.ConfigValues;
...
public class ConfigurableEnchantment extends CustomEnchantment {
    ...
    /**
     * Calculates the number of blocks or entities to spawn
     *
     * @param level enchantment level
     * @return      number of blocks or entities
     */
    public int spawn(int level) {
        return getInt(ConfigValues.SPAWN_BASE.getKey()) + getInt(ConfigValues.SPAWN_BONUS.getKey()) * level;
    }
    ...
    public boolean works(Entity entity, Entity entity2) {
        ...
        if (entity2 == null) return true;
            ...
            EntityDamageByEntityEvent event = new EntityDamageByEntityEvent(entity2, entity, EntityDamageEvent.DamageCause.ENTITY_ATTACK, 1);
