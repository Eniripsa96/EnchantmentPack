...
public class Trap {
     ...
     */
    public static boolean isTrapActive(String player, RedstoneTrap enchantment) {
     ...
     */
    public static Trap getTrap(String player, RedstoneTrap enchantment) {
     ...
     */
    public static void createTrap(Player player, RedstoneTrap enchantment, Location center, int radius, int level) {
     ...
     */
    public Trap(Player owner, RedstoneTrap enchantment, Location center, int radius, int level) {
